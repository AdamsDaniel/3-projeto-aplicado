...
**4. OWASP Top 10 2021:** A05:2021 – Security Misconfiguration, por afinidade.
A exposição de token e de informação sensível no repositório representa falha de
gestão/configuração de segredos. A CWE-540 permanece como taxonomia técnica
principal; este enquadramento OWASP não substitui a classificação CWE.
